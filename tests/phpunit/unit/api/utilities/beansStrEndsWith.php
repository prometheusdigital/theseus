...
class Tests_BeansStrEndsWith extends Test_Case {
	...
	public function test_should_correctly_identify_ending_string_pattern() {
		...
		$this->assertFalse( beans_str_ends_with( 'Really dig the Theseus framework! ', 'framework!' ) );
		$this->assertTrue( beans_str_ends_with( 'Really dig the Theseus framework! ', 'framework! ' ) );
