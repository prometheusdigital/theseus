...
class Tests_BeansStartsWith extends Test_Case {
	...
	public function test_should_correctly_identify_starting_string_pattern() {
		...
		$this->assertFalse( beans_str_starts_with( 'Really dig the Theseus framework! ', 'dig' ) );
		$this->assertTrue( beans_str_starts_with( 'Really dig the Theseus framework! ', 'Really ' ) );
