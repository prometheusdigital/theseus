...
class Tests_BeansUikit_ToFilename extends UIkit_Test_Case {
	...
	public function test_should_return_null_when_given_ignored_component() {
		...
		$this->assertNull( $beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/less/themes/default/uikit.less' ) );
	}
	...
	public function test_should_remove_min_extension_from_filename() {
		...
		$this->assertSame(
			'parallax',
			$beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/js/component/parallax.min.js' )
		);
		$this->assertSame(
			'tooltip',
			$beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/js/component/tooltip.min.js' )
		);
	}
	...
	public function test_should_return_component_filename_when_given_absolute_path() {
		...
		$this->assertSame(
			'accordion',
			$beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/less/component/accordion.less' )
		);
		$this->assertSame(
			'accordion',
			$beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/js/component/accordion.min.js' )
		);
		$this->assertSame(
			'sortable',
			$beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/less/component/sortable.less' )
		);
		$this->assertSame(
			'sortable',
			$beans_uikit->to_filename( THESEUS_API_PATH . 'uikit/src/js/component/sortable.min.js' )
		);
	}
