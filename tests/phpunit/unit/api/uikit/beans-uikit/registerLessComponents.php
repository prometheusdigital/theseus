...
class Tests_BeansUikit_RegisterLessComponents extends UIkit_Test_Case {
	...
	public function test_should_return_variables_and_fixes_when_no_theme_or_components_registered() {
		...
		$this->assertSame(
			[
				...
				THESEUS_API_PATH . 'uikit/src/fixes.less',
			],
	...
	public function test_should_return_array_of_core_paths_when_components_are_registered() {
		...
		$this->assertSame(
			[
				THESEUS_API_PATH . 'uikit/src/less/core/variables.less',
				THESEUS_API_PATH . 'uikit/src/less/core/article.less',
				THESEUS_API_PATH . 'uikit/src/less/core/base.less',
				THESEUS_API_PATH . 'uikit/src/less/core/block.less',
				THESEUS_API_PATH . 'uikit/src/less/core/grid.less',
				THESEUS_API_PATH . 'uikit/src/fixes.less',
			],
			( new _Beans_Uikit() )->register_less_components()
		);
	...
	public function test_should_return_array_of_add_ons_paths_when_components_are_registered() {
		...
		$this->assertSame(
			[
				THESEUS_API_PATH . 'uikit/src/less/core/variables.less',
				THESEUS_API_PATH . 'uikit/src/less/components/slidenav.less',
				THESEUS_API_PATH . 'uikit/src/fixes.less',
			],
			( new _Beans_Uikit() )->register_less_components()
		);
	...
	public function test_should_return_array_of_paths_when_components_are_registered() {
		...
		$this->assertSame(
			[
				...
				THESEUS_API_PATH . 'uikit/src/less/core/close.less',
				THESEUS_API_PATH . 'uikit/src/less/core/animation.less',
				THESEUS_API_PATH . 'uikit/src/less/core/flex.less',
				THESEUS_API_PATH . 'uikit/src/less/components/slideshow.less',
				THESEUS_API_PATH . 'uikit/src/less/components/dotnav.less',
				THESEUS_API_PATH . 'uikit/src/less/components/slidenav.less',
				THESEUS_API_PATH . 'uikit/src/fixes.less',
			],
			( new _Beans_Uikit() )->register_less_components()
	...
	public function test_should_include_theme_components_when_theme_is_registered() {
		$theme = THESEUS_API_PATH . 'uikit/src/themes/default';
