	...
	public function test_should_return_array_of_core_paths_when_components_are_registered() {
		...
		$this->assertSame(
			[
				...
				THESEUS_API_PATH . 'uikit/src/js/core/nav.min.js',
				THESEUS_API_PATH . 'uikit/src/js/core/smooth-scroll.min.js',
			],
			( new _Beans_Uikit() )->register_js_components()
		);
	}
	...
	public function test_should_return_array_of_add_ons_paths_when_components_are_registered() {
		...
		$this->assertSame(
			[
				...
				THESEUS_API_PATH . 'uikit/src/js/core/touch.min.js',
				// Enqueued items.
				THESEUS_API_PATH . 'uikit/src/js/components/accordion.min.js',
				THESEUS_API_PATH . 'uikit/src/js/components/notify.min.js',
			],
			( new _Beans_Uikit() )->register_js_components()
		);
	}
