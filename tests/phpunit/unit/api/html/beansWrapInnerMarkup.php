...
use PrometheusDigital\Theseus\Tests\Unit\API\HTML\Fixtures\Anonymous_Action_Stub;
...
class Tests_BeansWrapInnerMarkup extends HTML_Test_Case {
	...
	public function test_should_pass_extra_arguments_for_prepend_markup_hook() {
		...
		// Run the tests.
		$this->assertTrue( beans_wrap_inner_markup( 'extra_args', 'new_extra_args', 'div', [ 'class' => 'test-wrap' ], 47, 'Theseus Rocks!' ) );
		$this->assertSame( $args, $anonymous_action_mock->callback );
	...
	public function test_should_pass_extra_arguments_for_append_markup_hook() {
		...
		// Run the tests.
		$this->assertTrue( beans_wrap_inner_markup( 'extra_args', 'new_extra_args', 'div', [ 'class' => 'test-wrap' ], 'Theseus Rocks!', 47 ) );
		$this->assertSame( $args, $anonymous_action_mock->callback );
