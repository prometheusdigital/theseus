<?php
/**
 * Resets the Theseus framework back to its original starting point for each test.
 *
...
class Beans_Resetter {
	...
	/**
	 * Reset Theseus back to its original starting point.
	 */
	...
	/**
	 * Resets the Theseus' API Components.
	 */
