<?php
/**
 * Test Case for Theseus' WP Customize API integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\WP_Customize\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\WP_Customize\Includes;
...
abstract class WP_Customize_Test_Case extends Test_Case {
	...
	public function setUp() {
		...
		require_once THESEUS_THEME_DIR . '/lib/api/wp-customize/class-beans-wp-customize.php';
