 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\UIkit
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\UIkit;

use _Beans_Uikit;
use PrometheusDigital\Theseus\Tests\Integration\API\UIkit\Includes\UIkit_Test_Case;
use Brain\Monkey;
	...
	public function test_should_compile_styles() {
		...
		add_filter( 'beans_uikit_euqueued_styles', function( $styles ) {
			$this->assertSame( [
				...
				THESEUS_API_PATH . 'uikit/src/less/core/button.less',
				THESEUS_API_PATH . 'uikit/src/less/core/overlay.less',
...
EOB;
	...
	public function test_should_compile_styles_with_default_theme() {
		$theme_path = THESEUS_API_PATH . 'uikit/src/themes/default/';
	...
	public function test_should_compile_scripts() {
		...
		add_filter( 'beans_uikit_euqueued_scripts', function( $scripts ) {
			$this->assertSame( [
				...
				THESEUS_API_PATH . 'uikit/src/js/core/utility.min.js',
				THESEUS_API_PATH . 'uikit/src/js/core/touch.min.js',
