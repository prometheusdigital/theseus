<?php
/**
 * Test Case for Theseus' UIkit API integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\UIkit\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\UIkit\Includes;
...
abstract class UIkit_Test_Case extends Test_Case {
	...
	protected function reset_globals() {
		...
		$_beans_uikit_registered_items = [
			'themes' => [
				'default'         => THESEUS_API_PATH . 'uikit/src/themes/default',
				'almost-flat'     => THESEUS_API_PATH . 'uikit/src/themes/almost-flat',
				'gradient'        => THESEUS_API_PATH . 'uikit/src/themes/gradient',
				'wordpress-admin' => THESEUS_API_PATH . 'uikit/themes/wordpress-admin',
			],
		];
	}
