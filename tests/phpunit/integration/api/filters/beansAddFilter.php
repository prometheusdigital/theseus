 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Filters
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Filters;

use PrometheusDigital\Theseus\Tests\Integration\API\Filters\Includes\Filters_Test_Case;
...
class Tests_BeansAddFilter extends Filters_Test_Case {
	 ...
	 *
	 * Note: When the callback is not callable, Theseus creates an anonymous filter, where the "callback" parameter in
