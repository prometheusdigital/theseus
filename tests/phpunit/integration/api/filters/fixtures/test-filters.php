<?php
/**
 * Array of test filters, which is used to test Theseus Actions API against the original filter configurations.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Filters\Fixtures
 *
 * @since   1.5.0
 */
