<?php
/**
 * Test Case for Theseus Image API Options integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Image\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Image\Includes;
...
abstract class Options_Test_Case extends Base_Test_Case {
	...
	public static function setUpBeforeClass() {
		...
		require_once THESEUS_THEME_DIR . '/lib/api/image/class-beans-image-options.php';
	}
