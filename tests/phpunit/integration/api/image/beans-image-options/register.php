 ...
 *
 * @package PrometheusDigital\Theseus\Test\Integration\API\Image
 *
 * @since   1.5.0
 */
...
use PrometheusDigital\Theseus\Tests\Integration\API\Image\Includes\Options_Test_Case;
...
class Tests_BeansImageOptions_Register extends Options_Test_Case {
	...
	public function setUp() {
		...
		require_once THESEUS_THEME_DIR . '/lib/api/options/functions.php';
	}
