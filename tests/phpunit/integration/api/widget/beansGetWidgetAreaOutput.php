 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Widget
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Widget;

use PrometheusDigital\Theseus\Tests\Integration\API\Widget\Includes\Beans_Widget_Test_Case;
...
class Tests_BeansGetWidgetAreaOutput extends Beans_Widget_Test_Case {
	...
	/**
	 * Get the expected output (html) of the Theseus default primary sidebar.
	 */
