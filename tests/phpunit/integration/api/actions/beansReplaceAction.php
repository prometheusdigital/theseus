...
use PrometheusDigital\Theseus\Tests\Integration\API\Actions\Includes\Replace_Action_Test_Case;
...
class Tests_BeansReplaceAction extends Replace_Action_Test_Case {
	 ...
	 *
	 * Intent: We are testing to ensure Theseus is "load order" agnostic.
	 */
	...
	public function test_should_store_and_then_replace_action() {
		...
		foreach ( static::$test_actions as $beans_id => $original_action ) {
			// Check that the original action's callback was replaced in Theseus.
			...
			// Check that the "replaced" action has been stored in Theseus and WordPress.
