<?php
/**
 * Test Case for Theseus' Action API integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Actions\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Actions\Includes;
...
abstract class Actions_Test_Case extends Test_Case {
	...
	/**
	 * An array of Theseus' IDs for our test actions.
	 *
	 * @var array
	 */
	 ...
	 * @since 1.5.0
	 *
	 * @param string $id Optional. Theseus ID to register. Default is 'foo'.
	 *
	 * @return array
	 */
	...
	protected function go_to_post() {
		...
		$post_id = self::factory()->post->create( [ 'post_title' => 'Hello Theseus' ] );
