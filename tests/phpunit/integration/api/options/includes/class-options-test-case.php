<?php
/**
 * Test Case for Theseus' Options API integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Options\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Options\Includes;
...
abstract class Options_Test_Case extends Test_Case {
	...
	public function setUp() {
		...
		require_once THESEUS_THEME_DIR . '/lib/api/options/class-beans-options.php';
	}
