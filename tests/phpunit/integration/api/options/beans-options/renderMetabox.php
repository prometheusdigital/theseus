 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Options
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Options;

use _Beans_Options;
use PrometheusDigital\Theseus\Tests\Integration\API\Options\Includes\Options_Test_Case;
use Brain\Monkey;
...
class Tests_BeansOptions_RenderMetabox extends Options_Test_Case {
	...
	public function test_should_render_registered_fields() {
		...
		// Run the tests.
		$this->assertFileExists( THESEUS_THEME_DIR . '/lib/api/fields/types/checkbox.php' );
		$expected = <<<EOB
