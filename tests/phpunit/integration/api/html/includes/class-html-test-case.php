<?php
/**
 * Test Case for Theseus' HTML API integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\HTML\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\HTML\Includes;
