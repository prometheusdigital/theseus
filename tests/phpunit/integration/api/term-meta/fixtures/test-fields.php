 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Term_Meta\Fixtures
 *
 * @since 1.5.0
 */
	...
	'fields' => [
		[
			...
			'options' => [
				...
				'c'                => THESEUS_THEME_URL . 'lib/admin/assets/images/layouts/c.png',
				'c_sp'             => THESEUS_THEME_URL . 'lib/admin/assets/images/layouts/c_sp.png',
				'sp_c'             => THESEUS_THEME_URL . 'lib/admin/assets/images/layouts/sp_c.png',
			],
		],
		[
