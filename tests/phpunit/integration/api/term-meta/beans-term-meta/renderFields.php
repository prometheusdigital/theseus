 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Term_Meta
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Term_Meta;

use PrometheusDigital\Theseus\Tests\Integration\API\Term_Meta\Includes\Term_Meta_Test_Case;
use _Beans_Term_Meta;

require_once THESEUS_THEME_DIR . '/lib/api/term-meta/class-beans-term-meta.php';
require_once THESEUS_THEME_DIR . '/lib/api/term-meta/functions-admin.php';
...
class Tests_BeansTermMeta_RenderFields extends Term_Meta_Test_Case {
	...
	public function test_should_render_field_html() {
		// Register Theseus actions to render fields.
		...
		$beans_theme_url = THESEUS_THEME_URL;
