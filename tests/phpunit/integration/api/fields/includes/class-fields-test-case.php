<?php
/**
 * Test Case for Theseus' Field API integration tests.
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Fields\Includes
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Fields\Includes;
...
abstract class Fields_Test_Case extends Test_Case {
	...
	public function setUp() {
		...
		require_once THESEUS_THEME_DIR . '/lib/api/fields/class-beans-fields.php';
