 ...
 *
 * @package PrometheusDigital\Theseus\Tests\Integration\API\Fields
 *
 * @since   1.5.0
 */

namespace PrometheusDigital\Theseus\Tests\Integration\API\Fields;
...
class Tests_BeansField extends Fields_Test_Case {
	...
	public function setUp() {
		...
		// Load the field type.
		require_once THESEUS_THEME_DIR . '/lib/api/fields/types/field.php';
	...
	public function test_should_render_checkbox_field() {
		// Set up the test.
		require_once THESEUS_THEME_DIR . '/lib/api/fields/types/checkbox.php';
...
EOB;
	...
	public function test_should_render_radio_field() {
		// Set up the test.
		require_once THESEUS_THEME_DIR . '/lib/api/fields/types/radio.php';
