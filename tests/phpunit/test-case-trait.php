<?php
/**
 * Common functionality for the Theseus Test Suites.
 *
...
trait Test_Case_Trait {
	...
	/**
	 * Load the original Theseus' functions into memory before we start.
	 *
	...
	protected function load_original_functions( array $files ) {
		...
		foreach ( $files as $file ) {
			require_once THESEUS_TESTS_LIB_DIR . $file;
		}
	}
