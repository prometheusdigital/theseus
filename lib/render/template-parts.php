...
function beans_header_partial_template() {
	...
	require THESEUS_STRUCTURE_PATH . 'header-partial.php';
}
...
function beans_content_template() {
	...
	require_once THESEUS_STRUCTURE_PATH . 'content.php';
}
...
function beans_loop_template( $id = false ) {
	...
	if ( '' === locate_template( 'loop.php', true, false ) ) {
		require THESEUS_STRUCTURE_PATH . 'loop.php';
	}
...
function beans_comment_template() {
	...
	require THESEUS_STRUCTURE_PATH . 'comment.php';
}
...
function beans_widget_area_template() {
	...
	require THESEUS_STRUCTURE_PATH . 'widget-area.php';
}
...
function beans_footer_partial_template() {
	...
	require THESEUS_STRUCTURE_PATH . 'footer-partial.php';
}
...
/**
 * Set the content width based on the Theseus default layout.
 *
