 ...
 *
 * This function converts the wp_nav_menu to UIkit format. It uses the Theseus custom walker and also makes
 * use of the Theseus HTML API.
 *
 * @since 1.0.0
 *
...
function beans_modify_menu_args( $args ) {
	...
	// Stop if it isn't a Theseus menu.
	if ( ! $type ) {
		return $args;
	}
	...
	$attr = [
		'id'    => '%1$s',
		'class' => [ beans_get( 'menu_class', $args ) ],
	];
