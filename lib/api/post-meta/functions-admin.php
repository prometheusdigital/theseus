<?php
/**
 * The Theseus Post Meta component extends the Theseus Fields and makes it easy to add fields to any Post Type.
 *
 * @package PrometheusDigital\Theseus\API\Post_Meta
 *
 * @since 1.0.0
 */
 ...
 */
function beans_register_post_meta( array $fields, $conditions, $section, $args = [] ) {
	...
	require_once THESEUS_API_PATH . 'post-meta/class-beans-post-meta.php';
