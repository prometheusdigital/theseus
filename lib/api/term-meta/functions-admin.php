<?php
/**
 * The Theseus Term Meta component extends the Theseus Fields API and makes it easy add fields to any Taxonomy.
 *
 * @package PrometheusDigital\Theseus\API\Term_Meta
 *
 * @since 1.0.0
 */
...
function beans_register_term_meta( array $fields, $taxonomies, $section ) {
	...
	require_once THESEUS_API_PATH . 'term-meta/class-beans-term-meta.php';
