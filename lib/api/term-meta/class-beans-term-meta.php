<?php
/**
 * Class to handle the Theseus Term Meta Workflow.
 *
...
/**
 * Handle the Theseus Term Meta workflow.
 *
 * @since 1.0.0
 * @ignore
 * @access private
...
final class _Beans_Term_Meta {
	...
	public function __construct( $section ) {
		...
		$this->do_once();
		add_action( beans_get( 'taxonomy' ) . '_edit_form_fields', [ $this, 'render_fields' ] );
	}
	...
	private function do_once() {
		...
		add_action( beans_get( 'taxonomy' ) . '_edit_form', [ $this, 'render_nonce' ] );
