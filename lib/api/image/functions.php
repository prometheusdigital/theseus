<?php
/**
 * The Theseus Image component contains a set of functions to edit images on the fly.
 *
...
function beans_edit_image( $src, array $args, $output = 'STRING' ) {
	require_once THESEUS_API_PATH . 'image/class-beans-image-editor.php';
 ...
 */
function beans_edit_post_attachment( $post_id, $args = [] ) {
...
function beans_get_images_dir() {
	 ...
	 * @since 1.0.0
	 *
	 * @param string Default path to the Theseus' edited images storage directory.
	 */
...
/**
 * Add the "image options" to the Theseus Settings page.
 *
 * @since 1.5.0
 *
