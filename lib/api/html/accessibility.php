<?php
/**
 * This file contains Theseus accessibility features.
 *
...
function beans_output_skip_links( array $skip_links ) {
	beans_open_markup_e( 'beans_skip_links_list', 'ul', [ 'class' => 'beans-skip-links' ] );
...
function beans_accessibility_skip_link_fix() {
	$js = THESEUS_API_URL . 'html/assets/js/skip-link-fix' . THESEUS_MIN_JS . '.js';
	wp_enqueue_script( 'beans-skip-link-fix', $js, [], THESEUS_VERSION );
}
