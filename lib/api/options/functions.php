<?php
/**
 * The Theseus Options component extends the Theseus Fields API and makes it easy to add fields to a WordPress options page.
 *
 ...
 */
function beans_register_options( array $fields, $menu_slug, $section, $args = [] ) {
	...
	require_once THESEUS_API_PATH . 'options/class-beans-options.php';
