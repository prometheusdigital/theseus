<?php
/**
 * This class provides the means to handle the Theseus Options workflow.
 *
...
/**
 * Handle the Theseus Options workflow.
 *
 * @since 1.0.0
 * @ignore
 * @access private
...
final class _Beans_Options {
	...
	public function render_page( $page ) {
		...
		$column_class = beans_get( 'column', $boxes, [] ) ? ' column' : false;
	...
	public function process_actions() {
		...
		if ( beans_post( 'beans_save_options' ) ) {
			$this->save();
			add_action( 'admin_notices', [ $this, 'render_save_notice' ] );
		}
