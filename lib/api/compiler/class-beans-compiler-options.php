<?php
/**
 * This class handles adding the Theseus' Compiler options to the Theseus' Settings page.
 *
...
/**
 * Theseus Compiler Options Handler.
 *
 * @since   1.0.0
 * @ignore
 * @access  private
...
final class _Beans_Compiler_Options {
	...
	public function init() {
		...
		add_action( 'beans_field_flush_cache', [ $this, 'render_flush_button' ] );
		add_action(
			'beans_field_description_beans_compile_all_styles_append_markup',
			[ $this, 'render_styles_not_compiled_notice' ]
		);
		add_action(
			'beans_field_description_beans_compile_all_scripts_group_append_markup',
			[ $this, 'render_scripts_not_compiled_notice' ]
		);
	}
