...
function beans_field_image_assets() {
	...
	wp_enqueue_script( 'beans-field-media', THESEUS_API_URL . 'fields/assets/js/media' . THESEUS_MIN_CSS . '.js', [ 'jquery' ], THESEUS_VERSION );
}
...
function beans_field_image( array $field ) {
	$images      = array_merge( (array) $field['value'], [ 'placeholder' ] );
