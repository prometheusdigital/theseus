 ...
 *
 * @package PrometheusDigital\Theseus\API\Fields\Types
 *
 * @since   1.0.0
...
?>
	<div class="bs-image-wrap<?php echo 'placeholder' === $image_id ? ' bs-image-template' : ''; ?>">
		...
		<div class="bs-toolbar">
			<?php
			/**
			 * The image toolbar's dashicons' class attributes are deprecated in Theseus 1.5.  Instead, the .bs-button-{icon}
			 * class attributes are used and the icon is defined in the CSS via .bs-button-{icon}:before pseudo-element.
			 *
			 * The dashicons' class attributes remain in Theseus 1.x for backwards compatibility for customs scripts
			 * or styling. However, these will be removed in Theseus 2.0.
			 *
			 * @since 1.5.0
			 * @deprecated
			 */
