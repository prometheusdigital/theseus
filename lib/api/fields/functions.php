<?php
/**
 * The Theseus Fields component offers a range of fields which can be used in the WordPress admin.
 *
 ...
 *                                 database.
 *      @type string  $type        The type of field to use. Please refer to the Theseus core field types for more
...
function beans_register_fields( array $fields, $context, $section ) {
	...
	require_once THESEUS_API_PATH . 'fields/class-beans-fields.php';
...
function beans_field( array $field ) {
	...
	beans_open_markup_e( 'beans_field_wrap', 'div', [
	...
	beans_open_markup_e( 'beans_field_inside', 'div', [
		'class' => 'bs-field-inside',
	], $fields );

	if ( $group_field_type ) {
		beans_open_markup_e( 'beans_field_group_fieldset', 'fieldset', [
			'class' => 'bs-field-fieldset',
		], $field );
			beans_open_markup_e( 'beans_field_group_legend', 'legend', [
	...
	foreach ( $fields as $single_field ) {
		beans_open_markup_e( 'beans_field[_' . $single_field['id'] . ']', 'div', [
