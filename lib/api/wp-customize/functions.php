<?php
/**
 * The Theseus WP Customize component extends the Theseus Fields API and makes it easy
 ...
 */
function beans_register_wp_customize_options( array $fields, $section, $args = [] ) {
	...
	require_once THESEUS_API_PATH . 'wp-customize/class-beans-wp-customize.php';
