<?php
/**
 * Theseus Filters extend WordPress Filters by registering sub filters if they are told to do so.
 *
 * @package PrometheusDigital\Theseus\API\Filters
 */
 ...
 *                                          Theseus creates an anonymous function to hook into the filter event.
...
function _beans_add_anonymous_filter( $hook, $value, $priority = 10, $args = 1 ) {
	require_once THESEUS_API_PATH . 'filters/class-beans-anonymous-filters.php';
