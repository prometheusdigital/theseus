<?php
/**
 * The Theseus Utilities is a set of tools to ease building applications.
 *
 * Since these functions are used throughout the Theseus framework and are therefore required, they are
 * loaded automatically when the Theseus framework is included.
 *
 * @package PrometheusDigital\Theseus\API\Utilities
 *
 * @since   1.5.0
 */
 ...
 * @return string The callback content.
 */
function beans_render_function_array( $callback, $params = [] ) {
...
function beans_esc_attributes( $attributes ) {
	 ...
	 */
	$methods = apply_filters( 'beans_escape_attributes_methods', [
		'href'     => 'esc_url',
		'src'      => 'esc_url',
		'itemtype' => 'esc_url',
		'onclick'  => 'esc_js',
