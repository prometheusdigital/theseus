...
beans_open_markup_e( 'beans_html', 'html', str_replace( ' ', '&', str_replace( '"', '', beans_render_function( 'language_attributes' ) ) ) );
	...
	beans_open_markup_e(
		...
		beans_open_markup_e( 'beans_site', 'div', [ 'class' => 'tm-site' ] );

			beans_open_markup_e( 'beans_main', 'main', [ 'class' => 'tm-main uk-block' ] );
				...
				beans_open_markup_e( 'beans_fixed_wrap[_main]', 'div', 'class=uk-container uk-container-center' );
					...
					beans_open_markup_e(
						...
						beans_open_markup_e( 'beans_primary', 'div', [ 'class' => 'tm-primary ' . beans_get_layout_class( 'content' ) ] );
