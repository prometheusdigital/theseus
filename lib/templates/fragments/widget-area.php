...
function beans_widget_area_sidebar_primary() {
	echo beans_get_widget_area_output( 'sidebar_primary' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Echoes HTML output.
}
...
function beans_widget_area_sidebar_secondary() {
	echo beans_get_widget_area_output( 'sidebar_secondary' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Echoes HTML output.
}
...
function beans_widget_area_offcanvas_menu() {
	...
	echo beans_get_widget_area_output( 'offcanvas_menu' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Echoes HTML output.
}
