...
function beans_no_widget() {
	...
	if ( ! in_array( beans_get_widget_area( 'id' ), [ 'sidebar_primary', 'sidebar_secondary' ], true ) ) {
		return;
	}

	beans_open_markup_e( 'beans_no_widget_notice', 'p', [ 'class' => 'uk-alert uk-alert-warning' ] );
